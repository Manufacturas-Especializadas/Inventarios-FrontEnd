            ...
            <tr className="bg-white border-b border-slate-200">
              <td className="p-2">
                <input
                  type="text"
                  placeholder="Filtrar..."
                  className="w-full bg-slate-50 border border-slate-200 text-xs p-1.5 rounded outline-none focus:border-blue-400"
              ...
              <td className="p-2">
                <input
                  type="text"
                  placeholder="Filtrar..."
                  className="w-full bg-emerald-50 border border-emerald-200 text-xs p-1.5 rounded outline-none focus:border-emerald-400 text-center"
              ...
              <td className="p-2">
                <input
                  type="text"
                  placeholder="Filtrar..."
                  className="w-full bg-orange-50 border border-orange-200 text-xs p-1.5 rounded outline-none focus:border-orange-400 text-center"
              ...
              <td className="p-2">
                <input
                  type="text"
                  placeholder="Filtrar..."
                  className="w-full bg-blue-50 border border-blue-200 text-xs p-1.5 rounded outline-none focus:border-blue-400 text-center font-bold"
                  value={filters.stock}
              ...
              <td className="p-2">
                <input
                  type="text"
                  placeholder="Filtrar..."
                  className="w-full bg-slate-50 border border-slate-200 text-xs p-1.5 rounded outline-none"
